        ...
        <View>
            <RadioButton.Group
                ...
                <View style={[styles.radioButtonContainer, {backgroundColor : currentColors.base}]}>
                        <Text
                        style={[styles.radioButtonText, { color: currentColors.text }]}>Issues related to water{'\n'}and sanitation services
                        </Text>
                        <RadioButton.Android value="Issues related to water and sanitation services" 
                ...
                <View style={[styles.radioButtonContainer, {backgroundColor : currentColors.base}]}>
                        ...
                        <RadioButton.Android value="Requests for information on the opening hours of municipal services" 
                        color={currentColors.tint}
                        uncheckedColor={currentColors.text}/>
                </View>
                <View style={[styles.radioButtonContainer, {backgroundColor : currentColors.base}]}>
                        <Text
                        style={[styles.radioButtonText, { color: currentColors.text }]}>Reporting outages in{'\n'}online municipal services
                        </Text>
                        <RadioButton.Android value="Reporting outages in online municipal services" 
                        color={currentColors.tint}
                        uncheckedColor={currentColors.text}/>
                </View>

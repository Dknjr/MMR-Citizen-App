    ...
    >
      <BlurView intensity={50} style={styles.modalOverlay}>
        <View style={styles.modalContainer}>
          ...
          Nous vous remercions pour votre aide à l'amélioration de notre communauté. Nous vous tiendrons informé(e) de l'avancement et de la résolution du problème.
          </Text>
